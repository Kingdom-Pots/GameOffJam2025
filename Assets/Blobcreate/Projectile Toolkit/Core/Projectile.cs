// Copyright (c) 2022–2025 Blobcreate (Ge Ge)
...
namespace Blobcreate.ProjectileToolkit
{
	public static class Projectile
	{
		...
		/// <summary>
		/// Compensates for the error in physics engine and pushes accuracy to the final bit.
		/// It is recommended to always add this value to the launch velocity.
		/// </summary>
		public static Vector3 VelocityCompensation
		{
			// Equals to (-0.5f * Physics.gravity) of acceleration
			get => -0.5f * Time.fixedDeltaTime * Physics.gravity;
		}
		...
		/// <summary>
		/// Tests if a projectile with velocity startVelocity at point start will hit point end,
		/// and outputs the time of flight.
		/// </summary>
		/// <param name="startVelocity">The velocity at the start point, or launch velocity.</param>
